...
var init_node = __esm({
  "node_modules/@sveltejs/kit/dist/node.js"() {
    ...
    if (!globalThis.DOMException) {
      try {
        const { MessageChannel } = require("worker_threads"), port2 = new MessageChannel().port1, ab = new ArrayBuffer();
...
// .svelte-kit/output/server/chunks/index-164dc826.js
function noop2() {
}
function run(fn) {
  return fn();
...
// .svelte-kit/output/server/chunks/paths-396f020f.js
function set_paths(paths) {
  base = paths.base;
  assets = paths.assets || base;
}
var base, assets;
var init_paths_396f020f = __esm({
  ".svelte-kit/output/server/chunks/paths-396f020f.js"() {
    base = "";
    assets = "";
  }
...
var run_svelte_exports = {};
__export(run_svelte_exports, {
  default: () => Run
});
var stdoutStore, Run;
var init_run_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/run.svelte.js"() {
    ...
    Run = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_prefsStore = subscribe(prefsStore, (value) => $prefsStore = value);
      let stdout;
      $prefsStore.add_default_imports;
      srcStore.subscribe((src) => {
      });
      stdoutStore.subscribe((text) => {
      });
      $$unsubscribe_prefsStore();
      return `<a href="${escape(base, true) + "/"}" target="${"_self"}">Edit this code</a>
<h2>Running....</h2>
<div id="${"glowscript"}" class="${"glowscript"}"></div>
<div><textarea rows="${"10"}" cols="${"80"}" hidden${add_attribute("this", stdout, 0)}></textarea></div>`;
    });
  }
});
...
// node_modules/trouter/node_modules/regexparam/dist/regexparam.js
var require_regexparam = __commonJS({
  "node_modules/trouter/node_modules/regexparam/dist/regexparam.js"(exports, module2) {
  ...
  "node_modules/trouter/index.js"(exports, module2) {
    ...
    module2.exports = class Trouter {
      ...
      use(route, ...fns) {
        ...
        let { keys, pattern } = parse5(route, true);
        this.routes.push({ keys, pattern, method: "", handlers });
        return this;
      }
      add(method, route, ...fns) {
        let { keys, pattern } = parse5(route);
        let handlers = [].concat.apply([], fns);
        this.routes.push({ keys, pattern, method, handlers });
        return this;
      }
...
var require_build2 = __commonJS({
  "node_modules/sirv/build.js"(exports, module2) {
    ...
    function viaLocal(dir, isEtag, uri, extns) {
      ...
      for (; i2 < arr.length; i2++) {
        abs = normalize2(join(dir, name = arr[i2]));
    ...
    function send(req, res, file2, stats, headers2) {
      let code = 200, tmp, opts = {};
      headers2 = { ...headers2 };
      for (let key2 in headers2) {
      ...
      fs.createReadStream(file2, opts).pipe(res);
    }
    var ENCODING = {
      ".br": "br",
      ".gz": "gzip"
    ...
    module2.exports = function(dir, opts = {}) {
      ...
      let setHeaders = opts.setHeaders || noop4;
...
function parseURL(url) {
  ...
  if (!(url instanceof URL)) {
    ...
    const path2 = url.path != null ? url.path : `${url.pathname || ""}${url.search || ""}`;
    url = new URL(path2, origin);
  }
  return url;
}
...
var Request$2 = class {
  constructor(origin, {
    ...
    this.path = query ? util$c.buildURL(path2, query) : path2;
    this.origin = origin;
...
function write(client2, request2) {
  const { body: body2, method, path: path2, host, upgrade: upgrade2, headers: headers2, blocking } = request2;
...
function onError2(err, req, res) {
  ...
  if (typeof err === "string" || Buffer.isBuffer(err))
    ...
    res.end(err.message || import_http2.default.STATUS_CODES[code]);
}
...
var Polka = class extends import_trouter.default {
  constructor(opts = {}) {
    ...
    this.onError = opts.onError || onError2;
  ...
  listen() {
    (this.server = this.server || import_http2.default.createServer()).on("request", this.attach);
...
setCookie2.exports = parse4;
setCookie2.exports.parse = parse4;
...
var ssr = async (request_, response2) => {
  let request2;
  try {
    request2 = await getRequest(getBase(request_.headers), request_);
  } catch (error2) {
    response2.statusCode = error2.status || 400;
    return response2.end(error2.reason || "Invalid request body");
  }
  setResponse(response2, await server.respond(request2, {
    getClientAddress() {
      return request2.headers.get("x-forwarded-for");
    }
  }));
};
function getBase(headers2) {
  const protocol = "https";
  const host = headers2.host;
  return `${protocol}://${host}`;
}
var polkaServer = build_default().use(staticServe).use(ssr);
