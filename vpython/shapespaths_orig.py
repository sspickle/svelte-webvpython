...
from .vec_js import vector_js as vector, mag, norm
    
vec = vector

# List of names that are exported imported from this module with import *
__all__ = ['RackOutline', 'ToothOutline', 'addpos', 'convert', 'rotatecp', 'roundc', 'scalecp', 'shape_object', 'path_object', 'shapes', 'paths']
